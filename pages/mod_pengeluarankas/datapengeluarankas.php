<h3><i class="fa fa-trash fa-fw"></i>Data Pengeluaran Kas </h3><br>
<?php
...
echo'<table class="table table-striped table-bordered table-hover" id="dataTables-example">';
    ...
    while ($row = $record->fetch(PDO::FETCH_ASSOC)) {
            echo "<tr'>";                 
                ...
                echo "<td style='width:110px;  text-align:left; vertical-align: middle;' class='text-capitalize'><button title='Lihat Detil' id='detiltb_pengeluarankas' class='btn btn-primary' data-toggle='modal' href='#' data-target='#detilpkModal".$row['no_transaksi']."'> Lihat Detil <i class='fa fa-eye'></i></button></td>";
            echo '</tr>';
    }
    echo '</tbody>';
echo '</table>';
